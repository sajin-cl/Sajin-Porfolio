                ...
                <div className="p-6 flex flex-col grow">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 items-center">
                    <a
                      ...
                      className="text-sm border font-mono flex items-center justify-center gap-2 border-lime-400 text-white tracking-wide  w-full hover:bg-lime-400/20 transition-colors text-center py-1"
                    >
